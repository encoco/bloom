   ...
   <div class="wrap">
        ...
        <div class="main-button">
            ...
            <div class="login_id">
                ...
                <div class="idcheck">
        			<input type="button" class="email-verify-button" value="이메일인증" onclick="checkEmailDuplication()">
            ...
            <div class="login_pwck">
                <h4>비밀번호확인</h4>
                <input type="password" name="password" id="passwordConfirm" placeholder="****">
            </div>
            ...
            <div class="login_tel">
                <h4>전화번호</h4>
                <input type="text" name="tel" id="tel" placeholder="-빼고 입력 ex)01012345678">
            </div>
            <div class="login_rrn">
                <h4>생년월일 6자리</h4>
                <input type="text" name="RRN" id="RRN" placeholder="000101">
            </div>
 		            <div class="submit">
...
<script type="text/javascript">
	...
	function validateForm() {
	 ...
	 var passwordConfirm = document.getElementById('passwordConfirm').value.trim();
		...
		var RRN = document.getElementById('RRN').value.trim();
	    ...
	    if (!pattern.test(password)) {
	    	...
	    	alert('전화번호를 확인해주세요.ex) 01012345678 ');
	    	return false;
	    }
	     else if (RRN === "" || RRN.length !== 6) {
	    	alert('생년월일을 확인해주세요.');
	    	return false;
	  }
	     else if(temp_email !== document.getElementById('email').value.trim()){
	...
	window.onload = function() {
	 document.getElementById('userpwd').addEventListener('input', updatePasswordIconColor);
	};
</script>
